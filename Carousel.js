    ...
    $(document).ready(function () {
        ...
        $(".slider-icons").each(function () {
            ...
            owlCarousel.owlCarousel({
                ...
                margin: 10,
                nav: true,
                navText: ["<img src='https://i.imgur.com/YXA0LPt.png' alt='banL' style='width:48px;height:48px;'>", "<img src='https://i.imgur.com/f8Q8OBM.png' alt='banR' style='width:48px;height:48px;'>"],
                items: 1,
            });
        });
